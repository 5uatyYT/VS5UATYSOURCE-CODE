...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['mod creators'],
		['5uatyYoutube',		'5uaty',		'Main Programmer',					                    'https://fnfvs5uaty.wordpress.com',	0xFF53E52C],
		['Jerpez',		        'jerpez',		        'Creator of BFwGF',					            'https://gamebanana.com/members/1859117',	0xFFFFDD33],
